...
CREATE TABLE "voter_race_ethnicity" (
	...
	CONSTRAINT "voter_race_ethnicity_voter_id_category_unique" UNIQUE("voter_id","category")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "ballots" ADD COLUMN "voter_id" uuid NOT NULL REFERENCES "voters"("id");
